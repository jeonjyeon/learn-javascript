...
() => {
  ...
  htmlString = ['<div class="' + containerClassName + '" style="' + styleRules + '">', '<input type="' + inputType + '" aria-label="점수" placeholder="' + placeholderText + '" />', '<button type="button">' + buttonLabel + '</button>', '<output>' + outputValue + '</output>', '</div>'].join('');
