...
(() => {
  ...
  const results = [canWatchMovie({ age: 21, idCard: true }), canWatchMovie({ age: 15, idCard: false })];
...
(() => {
  ...
  const results = [needUmbrella({ isRaining: false, forecastRain: true }), needUmbrella({ isRaining: false, forecastRain: false })];
